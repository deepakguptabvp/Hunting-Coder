            ...
            : blogs?.map((blog, index) => {
                return (
                  <Link
                    ...
                    className="group rounded-xl border border-gray-200 dark:border-gray-700 p-6 transition-all duration-300 hover:shadow-lg hover:border-purple-300 dark:hover:border-purple-700 bg-white dark:bg-gray-800 transform hover:-translate-y-1"
